            ...
            {loading ? (
              ...
              filteredCryptos.map((crypto) => (
                <TableRow key={crypto.id}>
                  ...
                  <TableCell>{formatPrice(Number.parseFloat(crypto.priceUsd), currency)}</TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    {formatLargeNumber(Number.parseFloat(crypto.marketCapUsd), currency)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatLargeNumber(Number.parseFloat(crypto.volumeUsd24Hr), currency)}
                  </TableCell>
                </TableRow>
              ))
            )}
